...
#' @return Nothing
#' @export
archstabms_ddPCA_linear_model_datasets <- function(
  dataset_names,
  seq_position_offset,
  base_dir,
  output_dir,
  ...
  for(i in dataset_names){
    ...
    archstabms_ddPCA_linear_model(
      ...
      outpath = archstabms__format_dir(dir_suffix=paste0("_archstabms_ddPCA_linear_model_", i, "o1"), stagenum=stagenum, base_dir=output_dir))
  }
}
...
archstabms__plot_growthrate_violins <- function(
  ...
  ggplot2::ggsave(file.path(report_outpath, paste0("growthrate_violins_", dataset_name, "_", trait, "_Nham_aa_small", suffix, ".pdf")), d, width = 5, height = 3, useDingbats=FALSE)
  ...
  ggplot2::ggsave(file.path(report_outpath, paste0("growthrate_violins_", dataset_name, "_", trait, "_Nham_aa_small", suffix, "_hist.pdf")), d, width = 5, height = 2, useDingbats=FALSE)

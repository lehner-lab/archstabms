...
archstabms__optimal_library_design <- function(
  ...
  gr_thresholds <- list(
	...
	#Candidate mutations
	ddgs_dt <- ddg_dt[f_ddg_pred_conf==T & b_ddg_pred_conf==T & id_ref %in% archstabms__reachable_single_AA_mutants(nt_wtseq, position_offset)[["reachable_muts"]] & num_doubles>=min_num_doubles,]

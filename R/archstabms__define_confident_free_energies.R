...
#' archstabms__define_confident_free_energies
#'
#' Call confident ddGs.
#'
...
#' @param energy_max_ci maximum energy confidence interval (default:1)
#'
#' @return data.table with columns indicating confident free energies
#' @export
#' @import data.table
archstabms__define_confident_free_energies <- function(
  input_dt,
  report_outpath,
  ...
  input_dt[, conf := .SD[[1]] < energy_max_ci,,.SDcols = "ci95_kcal/mol"]
